...
- Set your browser window as "anchor" with F3, go on youtube, watch a video, you see something cool to draw? Press WIN+SPACE to quickly pause it, now draw it.
Or go on an image site with a lot of images, with WIN+ARROW you can scroll / go to another image without losing the pen touch.
